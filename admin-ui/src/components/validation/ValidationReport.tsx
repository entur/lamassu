...
export default function ValidationReport({ validationResult }: { validationResult: ValidationResult }): React.ReactElement {
  const theme = useTheme();

  const totalErrors = validationResult.summary.files.reduce((acc, file) => acc + file.errors.length, 0);
  ...
  return (
      <Box sx={{ mt: 8 }}>
        ...
        >
          ...
          <Typography variant='body1' sx={{ fontWeight: 700, mb: 2, ml: 2, color: hasErrors ? theme.palette.error.main : theme.palette.success.main }}>
