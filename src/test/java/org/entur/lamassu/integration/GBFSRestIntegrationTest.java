...
public class GBFSRestIntegrationTest extends AbstractIntegrationTestBase {
  ...
  public void testFeedProviderDiscovery() throws Exception {
    mockMvc
      .perform(get("/gbfs").contentType("application/json"))
  ...
  public void testGBFS() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/gbfs").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testGBFSVersions() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/gbfs_versions").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemInformation() throws Exception {
    mockMvc
      .perform(
        get("/gbfs/testatlantis/system_information").contentType("application/json")
      )
      .andExpect(status().isOk())
  ...
  public void testVehicleTypes() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/vehicle_types").contentType("application/json"))
      .andExpect(status().isOk())
      .andExpect(
  ...
  public void testFreeBikeStatus() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/free_bike_status").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemRegions() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/system_regions").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemPricingPlans() throws Exception {
    mockMvc
      .perform(
        get("/gbfs/testatlantis/system_pricing_plans").contentType("application/json")
      )
      .andExpect(status().isOk())
  ...
  public void testStationInformation() throws Exception {
    mockMvc
      .perform(
        get("/gbfs/testatlantis/station_information").contentType("application/json")
      )
      .andExpect(status().isOk())
  ...
  public void testStationStatus() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/station_status").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemHours() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/system_hours").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemCalendar() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/system_calendar").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testSystemAlerts() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/system_alerts").contentType("application/json"))
      .andExpect(status().isOk())
  ...
  public void testGeofencingZones() throws Exception {
    mockMvc
      .perform(get("/gbfs/testatlantis/geofencing_zones").contentType("application/json"))
      .andExpect(status().isOk())
      .andExpect(
  ...
  public void testUnknownProviderResponds404() throws Exception {
    mockMvc
      .perform(get("/gbfs/foobar/gbfs").contentType("application/json"))
